...
<meta charset="UTF-8">
    ...
    /* Main Footer */
    footer .main-footer{font-family: 'Acme';box-shadow: -3px -3px 5px black;	padding: 20px 0;	background: #30888D;    border-top: 2px solid black;}
    ...
    /* Copy Right Footer */
    .footer-copyright {	background-color: #30888D;	padding: 5px 0;box-shadow: -1px -1px 3px black;border-top:1px solid black;}
