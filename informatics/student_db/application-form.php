...
<body class="zf-backgroundBg"></body>
    ...
    <!---------Start of Application---------->
     <!---------Start of Header---------->
<ul class="header">
        <li class="zf-tempHeadContBdr"><h2 class="zf-frmTitle">
        <em>Informatics Northgate College, Alabang Admission Application Form</em></h2>
...
</div><div class="zf-clearBoth"></div></li><!---------Image Upload Ends Here---------->  
<!--fileupload-->
...
<div class="zf-tempContDiv">
<span> <input type="text" name="DOB" checktype="c4" value="" maxlength="25" placeholder=""/><label>dd-MMM-yyyy</label> </span><div class="zf-clearBoth"></div><p id="Date_error" class="zf-errorMessage" style="display:none;">Invalid value</p>
...
<li class="zf-tempFrmWrapper zf-large">
    ...
    <option value="OM">Outside of Muntinlupa:</option> 
        ...
        <div class="zf-tempContDiv">
        <span> <input type="text" name="SingleLine" checktype="c1" value="" maxlength="255" fieldType=1 placeholder="Others"/></span> <p id="SingleLine_error" class="zf-errorMessage" style="display:none;">Invalid value</p>
        </div><div class="zf-clearBoth"></div>
</select><p id="Dropdown_error" class="zf-errorMessage" style="display:none;">Invalid value</p>
</div><div class="zf-clearBoth">
...
<div class="zf-tempContDiv">
<span> <input type="text" name="student-occupation" checktype="c1" value="" maxlength="255" fieldType=1 placeholder=""/></span> <p id="SingleLine1_error" class="zf-errorMessage" style="display:none;">Invalid value</p>
</div><div class="zf-clearBoth"></div></li>
...
</div><div class="zf-clearBoth"></div></li><!---------Multiple Line Ends Here----------><!---------File Upload Starts Here---------->  
...
<div 
class="zf-termsMsg zf-descFld" 
>
<p style="margin: 12pt 0px; line-height: 1.2; direction: ltr" class="zw-paragraph heading0"><span style="vertical-align: baseline">It is required for the student to clear an non-graded examination and an admission fee of 500 pesos to be admitted to the school.</span><br /></p><div><span style="vertical-align: baseline">I agree with the terms and conditions of the school and declare that the information provided above is correct.</span> <br /></div></div>
<div class="zf-termsAccept"><input class="zf-checkBoxType zf-flLeft" name="TermsConditions" type="checkbox"><label class="zf-descFld">I accept the Terms and Conditions.</label></div></div></div><p class="zf-errorMessage" elname="error" id="TermsConditions_error" style="display:none;">Invalid value</p>
<div class="clearBoth"></div></li>

</ul>
</div><!---------template Container Starts Here---------->
<ul>
<li class="zf-fmFooter"><button class="zf-submitColor" >Submit</button></li></ul></div><!-- 'zf-templateWrapper' ends --></form></div><!-- 'zf-templateWidth' ends -->
...
var MandArray = []; 
var FieldArray = ["Name_First", "Name_Last", "DOB", "Male", "Female", "SingleLine", "Dropdown", "Dropdown1", "mother-name", "mother-occupation", "father-name", "father-occupation", "guardian-name", "guardian-occupation", "grade-level", "first-choice", "second-choice", "previous-school", "SingleLine1", "MultiLine", "payment", "nso", "form-138", "form-137", "good-moral", "baranggay-clearance", "transfer-certificate", "TermsConditions"];
