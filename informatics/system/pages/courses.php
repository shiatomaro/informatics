...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary float-left">List of Course/Strand</h6>
            ...
            <div class="table-responsive">
                <table class="table table-bordered text-black" id="courseDbTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Course/Strand Name</th>
                            <th>Course/Strand Description</th>
                            <th>Status</th>
                            <th>Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        $id = 0;
                        $sql = "SELECT * FROM course_tbl GROUP BY course_name ASC";
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="courseName" class="col-form-label"><b>Course/Strand Name</b> <small>(Ex.: BSIT.)</small><?php echo $required;?></label>
                    <input type="text" class="form-control" id="courseName" name="courseName" placeholder="Course Name" required>
                </div>
                <div class="form-group">
                    <label for="courseName" class="col-form-label"><b>Course/Strand Description </b><small>(Ex.: Bachelor of Science In...)</small><?php echo $required;?></label>
            ...
            <div class="modal-footer">
                ...
                <input type="hidden" name="previousCourseDesc" id="previousCourseDesc">
            </div>
            </form>
        </div>
    </div>
...
<script>
    $(document).ready(function(){
        var DbTable = $('#courseDbTable').DataTable({
            paging: false
        });
        ...
        $('.btn-status').on('click', function(){
            ...
            $('#btn-stat').on('click', function(){
                $.ajax({
                    url:"template/courses_action.php",
                    method:"POST",
        ...
        $('#showCourseModal').on('click', function(){
            $('#courseForm')[0].reset();
            $('.modal-title').html("<b>Add Course</b>");
        ...
        $('.btn-edit').on('click',function(){
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    $('#previousCourseDesc').val(data.courseDesc);
