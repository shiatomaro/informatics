...
$db = new DbConnection();
$optional = '<span class="text-secondary"><small> (Optional)</small></span>';
...
<head>
    ...
    <!-- Site Metas -->
    <title>Informatics College Norhtgate|Online Student Admission System</title>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.php">
                    <img src="images/logo11 (1).png" style="width:100px; height: 100px;" alt="" />
                </a>
