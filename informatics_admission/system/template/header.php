        ...
        <ul class="navbar-nav bg-gradient-light sidebar sidebar-light accordion <?php echo $ulSidebarToggle ?>" id="accordionSidebar">
            ...
            ?>
                ...
                <li class="nav-item <?php echo $coursesMenu; ?>">
                    <a class="nav-link collapsed pt-2 pb-1" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
            ...
            <!-- Nav Item - Examination Results -->
            <li class="nav-item <?php echo $examResults; ?>">
                <a class="nav-link pt-2 pb-1" href="./exam-results">
                    <i class="fas fa-fw fa-file"></i>
                    <span>Examination Results</span></a>
            </li>
