...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $grade_level = $_POST['grade-level'] !== '' ? $conn->real_escape_string($_POST['grade-level']) : null;
    ...
    try {
        ...
        if ($e->getCode() == 1062) {
            ...
            $stmt = $conn->prepare("UPDATE student_information SET fname = ?, mname = ?, lname = ?, email = ?, contact_num = ?, address = ?, citizenship = ?, civil_status = ?, rs_status = ?, occupation = ?, med_cond = ?, birthdate = ?, sex = ?, mother_fname = ?, mother_mname = ?, mother_lname = ?, mother_contact = ?, mother_occupation = ?, father_fname = ?, father_mname = ?, father_lname = ?, father_contact = ?, father_occupation = ?, guardian_fname = ?, guardian_mname = ?, guardian_lname = ?, guardian_contact = ?, guardian_occupation = ?, grade_level = ?, first_choice = ?, second_choice = ?, prev_school = ?, img_profile = ?, img_profile_filename = ?, img_payment = ?, img_payment_filename = ?, img_birthcert = ?, img_birthcert_filename = ?, img_form137 = ?, img_form137_filename = ?, img_form138 = ?, img_form137_filename = ?, img_goodmoral = ?, img_goodmoral_filename = ?, img_brgyclear = ?, img_brgyclear_filename = ?, img_transfercert = ?, img_transfercert_filename = ? WHERE user_id = ?");
            $stmt->bind_param("ssssssssssssssssssssssssssssssssssssssssssssssssi", $name_first, $name_middle, $name_last, $email, $contact_num, $address, $citizenship, $civil_status, $rs_status, $occupation, $med_condition, $birthdate, $sex, $mother_fname, $mother_mname, $mother_lname, $mother_contact, $mother_occupation, $father_fname, $father_mname, $father_lname, $father_contact, $father_occupation, $guardian_fname, $guardian_mname, $guardian_lname, $guardian_contact, $guardian_occupation, $grade_level, $first_choice, $second_choice, $prev_school, $img_profile, $img_profile_filename, $img_payment, $img_payment_filename, $img_birthcert, $img_birthcert_filename, $img_form137, $img_form137_filename, $img_form138, $img_form137_filename, $img_goodmoral, $img_goodmoral_filename, $img_brgyclear, $img_brgyclear_filename, $img_transfercert, $img_transfercert_filename, $user_id);
